/*
Link: https://www.youtube.com/watch?v=SP880DBRJ_8&list=PL-Jc9J83PIiHfqDcLZMcO9SsUDY4S3a-v&index=10
...
public class _9_KnightsTour {
    ...
    public static void printKnightsTour(int[][] chess, int r, int c, int moveNo){
        ...
        chess[r][c] = 0;  // making move unOccupied
    }
}
